...
export default function SendMoneySection() {
  return (
    <section className="w-full bg-white dark:bg-[#111] py-24 px-6 sm:px-10 transition-colors duration-300">
      <div className="max-w-[1300px] mx-auto flex flex-col lg:flex-row items-start lg:items-center gap-16 lg:gap-28">
        ...
        <div className="flex flex-col items-center w-full lg:w-1/2">
          ...
          <div className="mt-10 flex gap-6 justify-center">
            ...
            <button className="px-8 py-2.5 rounded-full bg-gray-100 text-gray-800 font-medium hover:bg-gray-200 dark:bg-gray-800 dark:text-gray-200 dark:hover:bg-gray-700 transition">
              Deposit
            </button>
            <button className="px-8 py-2.5 rounded-full bg-gray-100 text-gray-800 font-medium hover:bg-gray-200 dark:bg-gray-800 dark:text-gray-200 dark:hover:bg-gray-700 transition">
              Withdraw
        ...
        <div className="w-full lg:w-1/2 flex flex-col justify-center">
          ...
          <p className="text-gray-600 dark:text-gray-300 text-lg leading-relaxed mb-8 max-w-xl">
