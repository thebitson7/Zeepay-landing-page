...
export default function CardFeatureSection() {
  return (
    <section className="relative w-full py-24 px-6 sm:px-10 bg-gradient-to-br from-[#f3f6fb] via-[#f9f9fb] to-[#e4ecfd] dark:from-[#0f0f0f] dark:via-[#1a1a1a] dark:to-[#121212] transition-colors duration-300 overflow-hidden">
