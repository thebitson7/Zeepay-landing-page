...
const Hero = () => {
  return (
    <section className="w-full bg-gradient-to-br from-[#f7f9fc] via-[#f2f4f8] to-[#f9fafb] py-20 px-6 sm:px-12">
      <div className="max-w-[1200px] mx-auto flex flex-col-reverse lg:flex-row items-center justify-between gap-16">
        ...
        <div className="flex-1 text-center lg:text-left">
          ...
          <p className="text-gray-600 text-base sm:text-lg mb-10 leading-relaxed max-w-xl mx-auto lg:mx-0">
